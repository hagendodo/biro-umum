        ...
        <div class="col-12">
            <form method="POST" action="">
                ...
                <div class="form-group mb-2">
                    <textarea class="form-control" placeholder="Pesan" rows="8"></textarea>
                </div>
            <button type="submit" class="btn text-white" style="background-color: #73a9ad; border-color: #73a9ad; float:right;">Kirim</button>
            </form>
        </div>
    </div>
</div>
